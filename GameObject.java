 ...
 *
 * I also change the overlaps() method, giving it a marginal error of 10 pixel horizontally
 * and vertically.
 */
public class GameObject {
     ...
     * I add + and - 10 so that the overlap area will be smaller to make the game easier.
     */
    public boolean overlaps(GameObject other) {
        if (getLeftX()>other.getRightX()-10||getRightX()<other.getLeftX()+10){
            return false;
        }
        if (getBottomY()<other.getTopY()+10||getTopY()>other.getBottomY()-10){
            return false;
        }
        return true;
    }
